...
export type DeleteTodoMutation = { __typename?: 'Mutation', deleteTodo: { __typename?: 'Todo', id: string, title: string, completed: boolean, createdAt: string, updatedAt: string, user: { __typename?: 'User', id?: string | null, name?: string | null, email?: string | null } } };
